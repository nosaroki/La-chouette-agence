...
+(function (d) {
  ...
  +(function (f) {
    ...
    (h.VERSION = "3.3.5"),
      (h.DEFAULTS = { loadingText: "loading..." }),
          ...
          setTimeout(
            f.proxy(function () {
              k[j](null == i[a] ? this.options[a] : i[a]),
                "loadingText" == a
                  ? ((this.isLoading = !0), k.addClass(l).attr(l, l))
                  : this.isLoading &&
                    ((this.isLoading = !1), k.removeClass(l).removeAttr(l));
            }, this),
            0
          );
      }),
        ...
        .on(
          ...
          function (b) {
            ...
            a.hasClass("btn") || (a = a.closest(".btn")),
              e.call(a, "toggle"),
              f(b.target).is('input[type="radio"]') ||
                f(b.target).is('input[type="checkbox"]') ||
                b.preventDefault();
          }
        )
        .on(
  ...
  +(function (g) {
    ...
    (j.VERSION = "3.3.5"),
      ...
      (j.DEFAULTS = { interval: 5000, pause: "hover", wrap: !0, keyboard: !0 }),
      ...
      (j.prototype.slide = function (v, u) {
        ...
        var o = s[0],
          n = g.Event("slide.bs.carousel", { relatedTarget: o, direction: q });
        ...
        if (!q.is(".disabled, :disabled")) {
          ...
          if ((p(), !b)) {
            ...
            q.trigger("focus").attr("aria-expanded", "true"),
              c.toggleClass("open").trigger("shown.bs.dropdown", a);
          }
          return !1;
        }
      }),
      ...
      f(document).on(
        ...
        function (k) {
          var j = f(this),
            ...
            a = b.data("bs.modal")
              ? "toggle"
              : f.extend({ remote: !/#/.test(i) && i }, b.data(), j.data());
  ...
  +(function (f) {
    ...
    (h.VERSION = "3.3.5"),
      ...
      (h.prototype.getCalculatedOffset = function (j, i, l, k) {
        return "bottom" == j
          ? { top: i.top + i.height, left: i.left + i.width / 2 - l / 2 }
          : "top" == j
          ? { top: i.top - k, left: i.left + i.width / 2 - l / 2 }
          : "left" == j
          ? { top: i.top + i.height / 2 - k / 2, left: i.left - l }
          : { top: i.top + i.height / 2 - k / 2, left: i.left + i.width };
      }),
